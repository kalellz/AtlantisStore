                ...
                <div className={logup.SignInfos}>
                    <div className={logup.SignInputs}>
                        <div className={logup.form__group}>
                            <input placeholder="Name" className={logup.form__field} onKeyDown={SignClick} type="input" value={name} onChange={e => setName(e.target.value)} />
                            <label className={logup.form__label}>Nome</label>
                        </div>
                        <div className={logup.form__group}>
                            <input placeholder="Name" className={logup.form__field} onKeyDown={SignClick} type="email" value={email} onChange={e => setEmail(e.target.value)} />
                            <label className={logup.form__label}>Email</label>
                        </div>
                        <div className={logup.form__group}>
                            <input placeholder="Name" className={logup.form__field} onKeyDown={SignClick} type="password" value={password} onChange={e => setPassword(e.target.value)} />
